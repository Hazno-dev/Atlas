...
export module Atlas.Log:Patterner;

export class Logger_Patterner final : public spdlog::formatter
{
	...
	public:
		...
		void PatternLogger(const std::shared_ptr<spdlog::logger>& logger, const std::string& pattern)
		{
