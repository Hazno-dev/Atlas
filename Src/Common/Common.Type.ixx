...
//Numeric
EXPORT_CONCEPT(Cpt_Integral, (t_input), std::negation_v<std::is_same<t_input, bool>> && (std::is_integral_v<std::remove_cv_t<t_input>>
...
//Utility
EXPORT_CONCEPT(Cpt_Matches, (t_input, ... t_values), (std::same_as<t_input, t_values> || ...));
EXPORT_CONCEPT_MANUAL(Cpt_Equals, (auto t_input, auto... t_values), ((t_input == t_values) || ...));
